...
const TemplateSchema = CollectionSchema(
  ...
  properties: {
    r'category': PropertySchema(
      ...
      enumMap: _TemplatecategoryEnumValueMap,
    ),
...
Template _templateDeserialize(
  ...
  object.category =
      _TemplatecategoryValueEnumMap[reader.readStringOrNull(offsets[0])] ??
...
P _templateDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_TemplatecategoryValueEnumMap[reader.readStringOrNull(offset)] ??
          TemplateCategory.whatsapp) as P;
    case 1:
...
const _TemplatecategoryEnumValueMap = {
  r'whatsapp': r'whatsapp',
  r'email': r'email',
  r'tips': r'tips',
};
const _TemplatecategoryValueEnumMap = {
  r'whatsapp': TemplateCategory.whatsapp,
  r'email': TemplateCategory.email,
  r'tips': TemplateCategory.tips,
};
...
extension TemplateQueryFilter
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> isPremiumEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sortOrderEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sortOrderGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sortOrderLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, Template, QAfterFilterCondition> sortOrderBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TemplateQuerySortBy on QueryBuilder<Template, Template, QSortBy> {
  ...
  QueryBuilder<Template, Template, QAfterSortBy> sortByIsPremium() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremium', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> sortByIsPremiumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremium', Sort.desc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> sortBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> sortBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQuerySortThenBy
  ...
  QueryBuilder<Template, Template, QAfterSortBy> thenByIsPremium() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremium', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> thenByIsPremiumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPremium', Sort.desc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> thenBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<Template, Template, QAfterSortBy> thenBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.desc);
    });
  }
...
extension TemplateQueryWhereDistinct
  ...
  QueryBuilder<Template, Template, QDistinct> distinctByIsPremium() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isPremium');
    });
  }

  QueryBuilder<Template, Template, QDistinct> distinctBySortOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension TemplateQueryProperty
  ...
  QueryBuilder<Template, TemplateCategory, QQueryOperations>
      categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Template, bool, QQueryOperations> isPremiumProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isPremium');
    });
  }

  QueryBuilder<Template, int, QQueryOperations> sortOrderProperty() {
    return QueryBuilder.apply(this, (query) {
