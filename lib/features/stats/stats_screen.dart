...
class StatsScreen extends StatefulWidget {
  final Future<Map<ApplicationStatus, int>> Function()? statusBreakdownLoader;
  final Future<Map<JobPlatform, int>> Function()? platformBreakdownLoader;
  final Future<int> Function()? totalCountLoader;

  const StatsScreen({
    super.key,
    this.statusBreakdownLoader,
    this.platformBreakdownLoader,
  ...
  Future<void> _loadData() async {
    ...
    try {
      final statusBreakdown =
          await (widget.statusBreakdownLoader?.call() ??
              JobRepository.getStatusBreakdown());
      final platformBreakdown =
          await (widget.platformBreakdownLoader?.call() ??
              JobRepository.getPlatformBreakdown());
      final totalCount =
          await (widget.totalCountLoader?.call() ?? JobRepository.getCount());
